    ...
    return (
        <section id="home" className="md:flex md:justify-between md:items-center md:h-full gap-16 py-10">
            ...
            <div className="z-30 basis-2/5 mt-12 md:mt-32">
                    {/* HEADINGS */}
                    <motion.div
                    className="flex-column mt-5 justify-center md:justify-start"
                        initial="hidden"
                        whileInView="visible"
                        ...
                        variants={{
                            ...
                            <p className="mt-10 mb-7 text-sm text-center md:text-start">
                                Lorem ipsum, dolor sit amet consectetur adipisicing elit. Eum eius dolor aspernatur ut ipsa rem hic reprehenderit ipsum soluta eveniet laborum quod maxime sapiente, assumenda sint excepturi, cumque quibusdam consectetur.
                            </p>
                    </motion.div>
